...
#railway_dashed_white::outline[zoom>=11][zoom<=20],
#tunnel[render='1_outline'][zoom>=11][zoom<=20],
#bridge[render='1_outline'][zoom>=11][zoom<=20] {
	/* -- colors & styles -- */
  line-cap: round;
  ...
  [stylegroup='railway'] {
	...
	[zoom=17] { line-width: 3 + 4; } // 3 + 4
    [zoom>=18] { line-width: 4 + 6; }
  }     
  [tunnel=1] { line-dasharray: 3,3; }   
}

#railway_dashed_white[zoom>=11][zoom<=20],
#tunnel[render='3_inline'][zoom>=11][zoom<=20],
#bridge[render='3_inline'][zoom>=11][zoom<=20] {
  /* -- colors & styles -- */
  line-color: @standard_fill;
...
#railway_base_gray[zoom>=11][zoom<=20] {
	[stylegroup='railway'] {
